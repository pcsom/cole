...
parser = argparse.ArgumentParser(description='NASBench-201 robust comparison with CodeLlama and ModernBERT embeddings')
parser.add_argument('--corpus_path', type=str, help='Path to the input corpus')
parser.add_argument('--output_corpus_path', type=str, help='Path to save the output corpus')
parser.add_argument('--output_path', type=str, help='Path to save the comparison results CSV')
parser.add_argument('--output_path_csv', type=str, help='Path to output directory for per-embedding CSVs')
...
results_df = run_comparison(
    ...
    embedding2_name=f'modernbert_large_grammar_code_fp16_embedding',
