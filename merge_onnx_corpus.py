...
args = argparse.ArgumentParser(description='Merge NASBench-201 corpus with true ONNX encodings')
args.add_argument('--corpus_path', type=str, required=True, help='Path to the input corpus (.pkl file)')
args.add_argument('--onnx_csv_path', type=str, required=True, help='Path to the ONNX encodings CSV file')
args.add_argument('--output_path', type=str, required=True, help='Path to save the merged corpus (.pkl file)')

# Paths
EXISTING_CORPUS_PATH = args.corpus_path
ONNX_CSV_PATH = args.onnx_csv_path
