...
parser.add_argument('--out_dir', type=str, required=True, help='Results output directory')
parser.add_argument('--embeddings_corpus', type=str, required=True, help='Path to embeddings corpus file')
parser.add_argument('--embedding_name', type=str, default='codellama_python_7b_pytorch_code_exclude_helper_embedding', help='Name of column of embedding to use in the embedding corpus')
        ...
        if SURROGATE == "xgboost":
            run_experiment(
                ...
                predictor_kwargs={
                    ...
                    "corpus_path": args.embeddings_corpus,
                    "embedding_col": args.embedding_name,
                    "use_pca": False,
                    "pca_components": 128,
