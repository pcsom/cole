...
# --- Configuration ---
import argparse
parser = argparse.ArgumentParser(description="Plot search trajectory comparison")
parser.add_argument('--space', type=str, default="nasbench201", help="Search space name")
parser.add_argument('--dataset', type=str, default="cifar100", help="Dataset name")
parser.add_argument('--start_seed', type=int, default=10500, help="Starting seed")
parser.add_argument('--seeds', type=int, nargs='+', default=[10500, 10501, 10502, 10503], help="List of seeds")
parser.add_argument('--trials', type=int, default=25, help="Number of trials")
parser.add_argument('--surrogate', type=str, default="mlp", help="Surrogate model type")
...
formal_name = {'nasbench201': 'NAS-Bench-201'}
...
if len(method_means) >= 1:
    ...
    with open(txt_filename, 'w') as f:
        ...
        threshold_percentages = [0.98, 0.985, 0.9875, 0.99, 0.9925, 0.995]
